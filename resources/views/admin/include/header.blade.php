                ...
                <li class="nav-item dropdown dropdown-large">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center gap-1">
                            <img src="{{ asset('admin-assets') }}/assets/images/avatars/majeda.jpg" class="user-img" alt="">
                            <div class="user-name d-none d-sm-block">MST Majeda Khatun</div>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('admin-assets') }}/assets/images/avatars/majeda.jpg" alt="" class="rounded-circle" width="60" height="60">
                                    <div class="ms-3">
                                        <h6 class="mb-0 dropdown-user-name">MST Majeda</h6>
                                        <small class="mb-0 dropdown-user-designation text-secondary">Editor</small>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="#" onclick="event.preventDefault();document.getElementById('myLogout').submit()">
                                <div class="d-flex align-items-center">
